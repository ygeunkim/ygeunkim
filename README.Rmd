...
- `r emo::ji("graduation")` B.E. in Statistics at **[department of statistics, Sungkyunkwan University](https://stat.skku.edu/stat/index.do)**
...
```{r lrdmulti, fig.cap="Generate LRD Time Series"}
lrd_data %>% 
  mutate(id = 1:n()) %>% 
